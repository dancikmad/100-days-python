...
if __name__ == "__main__":
    while True:
        launch = input(Fore.GREEN + "Press " + Back.WHITE + Fore.BLACK + " Enter " + Style.RESET_ALL +
                       Fore.GREEN + " to run the final project you built or type 'q' to quit: " + Style.RESET_ALL)
        ...
        try:
            ...
            print(Fore.CYAN + f"Each person should pay: ${final_amount:.2f}" + Style.RESET_ALL)
